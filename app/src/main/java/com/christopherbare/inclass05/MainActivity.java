package com.christopherbare.inclass05;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetImageURLSAsync extends AsyncTask<String, String, String> {
        ...
        @Override
        protected void onPreExecute() {
            pd.setMessage("Retrieving image, please stand by. This might take a moment.");
            pd.show();
        }
    ...
    private class GetImageAsync extends AsyncTask<String, String, Bitmap> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog.setMessage("Accessing image. Please wait.");
            dialog.show();
        }
